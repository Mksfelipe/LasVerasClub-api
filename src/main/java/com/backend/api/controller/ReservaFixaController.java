...
public class ReservaFixaController {
	...
	@DeleteMapping("/{reservaFixaId}")
	public void cancelarReservaFixa(@PathVariable Long reservaFixaId) {
		reservaFixaService.cancelarReservaFixaAssociadas(reservaFixaId);
	}
	@GetMapping
